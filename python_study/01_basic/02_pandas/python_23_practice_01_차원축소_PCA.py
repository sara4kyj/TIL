# -*- coding: utf-8 -*-
"""
Created on Thu Jan  6 14:37:30 2022
...
# PCA 적용 전 스케일링 변환
# ---------------------------------------------------------------------------
# 3. 주성분 갯수 설정 축소 작업(주성분 개수: 2개 설정)
from sklearn.decomposition import PCA
m_pca2 = PCA(n_components=2)
iris_x_pca2 = m_pca2.fit_transform(iris_x_sc)  # >> 2차원으로 축소됨
...
print('m_knn1.score: ' ,m_knn1.score(test_x1, test_y1))     
print('pca2 :', m_pca2.explained_variance_ratio_)    # 각 인공변수의 분산 설명력
print('pca2_sum :',sum(m_pca2.explained_variance_ratio_))

m_knn2.fit(train_x2, train_y2)
print('m_knn2.socre: ',m_knn2.score(test_x2, test_y2))     
print('pca3 :', m_pca3.explained_variance_ratio_)    # 각 인공변수의 분산 설명력
print('pca3_sum :',sum(m_pca3.explained_variance_ratio_)) 

# m_knn1.score:  0.8947368421052632
# pca2 : [0.72962445 0.22850762]
# pca2_sum : 0.9581320720000164
# m_knn2.socre:  0.8947368421052632
# pca3 : [0.72962445 0.22850762 0.03668922]
# pca3_sum : 0.9948212908928451
